...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create rail' do
    assert_difference('Rail.count') do
      post rails_url, params: { rail: { User: @rail.User, g: @rail.g, name: @rail.name, scaffold: @rail.scaffold } }
    end
  ...
  test 'should update rail' do
    patch rail_url(@rail),
          params: { rail: { User: @rail.User, g: @rail.g, name: @rail.name, scaffold: @rail.scaffold } }
